function POES_BAYES = BAYES(D_BG, D_FG, strategy, alpha)
    ...
    for idx_alpha = 1 : size(alpha,2)
        ...
        for idx_x = 1 : sizeX 
            for idx_y = 1 : sizeY
                ...
                temp_likelyhood_BG_BAYES = mvnpdf(x_dcts_all,mu_BG, Sample_Cov_BG + Sigma_BG);
                temp_likelyhood_FG_BAYES = mvnpdf(x_dcts_all,mu_FG, Sample_Cov_FG + Sigma_FG);
                %% predict
