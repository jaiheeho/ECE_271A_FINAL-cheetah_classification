...
%             +  Sample_Cov_FG./nrows_FG * inv_sigma_FG * mu0_FG.').';
        ...
        for idx_x = 1 : sizeX 
            for idx_y = 1 : sizeY
                ...
                % calculate likelihood for ML
                temp_likelyhood_BG_ML =  mvnpdf(x_dcts_all,Sample_mean_BG,Sample_Cov_BG);
                temp_likelyhood_FG_ML =  mvnpdf(x_dcts_all,Sample_mean_FG,Sample_Cov_FG);
